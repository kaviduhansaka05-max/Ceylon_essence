    ...
    <div class="overflow-x-auto">
      <table class="min-w-full table-auto">
        ...
        <tbody class="divide-y divide-slate-100 text-sm text-slate-800">
          @forelse ($users as $u)
            @php
              // avatar url: prefer Jetstream's accessor if present; else try storage path; else placeholder
          ...
          @empty
            <tr>
              <td class="px-4 py-8 text-slate-500" colspan="10">No users found.</td>
            </tr>
          @endforelse
        </tbody>
      </table>
