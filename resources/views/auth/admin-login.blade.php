  ...
  <div class="relative min-h-screen flex items-center justify-center bg-gray-100 px-4">
    ...
    >
      ...
      <div class="bg-white p-8 md:p-12">
        ...
        <form method="POST" action="{{ route('login.admin.submit') }}" class="space-y-6">
          @csrf
          ...
          <div class="pt-2">
            <x-button
              class="w-full justify-center rounded-full bg-rose-600 hover:bg-rose-700 border-0 py-3 text-base shadow-lg"
            >
              {{ __('Log in') }}
            </x-button>
          </div>
