            ...
            <section class="col-span-12 md:col-span-9">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6">
                    @forelse($products as $product)
                        ...
                        <div class="relative group rounded-[22px] bg-white border border-rose-200 shadow-[0_10px_25px_-10px_rgba(0,0,0,0.25)]
                            ...
                            <div class="relative">
                                <div class="h-64 sm:h-72 w-full overflow-hidden">
                                    <img src="{{ $img }}" alt="{{ $name }}" class="h-full w-full object-cover select-none pointer-events-none" />
                                    <div class="pointer-events-none absolute inset-0 bg-gradient-to-b from-white/10 via-transparent to-black/0"></div>
                                </div>
                                @if($category)
                                    <span class="absolute top-3 right-3 text-[11px] px-2 py-0.5 rounded-full bg-white/95 text-gray-700 shadow">
                                        {{ $category }}
                                    </span>
                                @endif
                            </div>
